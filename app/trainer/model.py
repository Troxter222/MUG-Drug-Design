...
class MolecularVAE(nn.Module):
    def __init__(self, vocab_size, embed_size=64, hidden_size=256, latent_size=128, num_layers=3):
    ...
    def forward(self, x):
        ...
        hidden = hidden.view(x.size(0), self.num_layers, self.hidden_size).permute(1, 0, 2).contiguous()
